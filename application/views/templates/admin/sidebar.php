...
-------------------->
            <div class="menu-mobile menu-activated-on-click color-scheme-dark">
                <div class="mm-logo-buttons-w"><a class="mm-logo" href="index-2.html"><img src="img/logo.png"><span>Clean Admin</span></a>
...
-------------------->
            ...
            <div class="menu-w color-scheme-light color-style-transparent menu-position-side menu-side-left menu-layout-compact sub-menu-style-over sub-menu-color-bright selected-menu-color-light menu-activated-on-hover menu-has-selected-link">
                <div class="logo-w"><a class="logo" href="<?= base_url('admin'); ?>">
                        <div class="logo-element">
                        </div>
                        <div class="logo-label">Admin E-legalisir</div>
                    </a></div>
                <h1 class="menu-page-header">Page Header</h1>
                <ul class="main-menu">
                    <!-- LOOPING HEADER MENU -->
                    <?php foreach ($menu as $m) : ?>
                        <li class="sub-header"><span><?= $m['menu'];  ?></span></li>


                        <!-- LOOPING QUERY SUB MENU -->
                        <?php
                        $menuId = $m['id'];
                    ...
                    ";
                        ...
                        <?php foreach ($subMenu as $sm) : ?>
                            <?php if ($title == $sm['title']) : ?>
                                <li class=" not-has-sub-menu active">
                                <?php else : ?>
                                <li class=" not-has-sub-menu">
                                <?php endif; ?>
                                <a href="<?= base_url($sm['url']); ?>">
                                    <div class="icon-w">
                                        <div class="<?= $sm['icon']; ?>"></div>
                                    </div><span><?= $sm['title']; ?></span>
                                </a>
                            </li>
                    ...
                    <!-- <li class="sub-header"><span>Pembayaran</span></li>
                    <li class=" not-has-sub-menu"><a href="#">
                            <div class="icon-w">
                                <div class="os-icon os-icon-coins-4"></div>
                            </div><span>Invoice</span>
                        </a>
                    </li>
                    <li class="sub-header"><span>Manage Legalisir</span></li>

                    <li class=" not-has-sub-menu"><a href="#">
                            <div class="icon-w">
                                <div class="os-icon os-icon-agenda-1"></div>
                            </div><span>Permintaan Legalisir</span>
                        </a>
                    </li>
                    <li class="sub-header"><span>Manage Koresponden</span></li>
                    <li class=" not-has-sub-menu"><a href="#">
                            <div class="icon-w">
                                <div class="os-icon os-icon-edit-1"></div>
                            </div><span>Question Koresponden</span>
                        </a>
                    </li>
                    <li class=" not-has-sub-menu"><a href="#">
                            <div class="icon-w">
                                <div class="os-icon os-icon-tasks-checked"></div>
                            </div><span>Answer Koresponden</span>
                        </a>
                    </li> -->
