        ...
        <div class="content-box">
            <div class="element-wrapper">
                ...
                <div class="element-box">
                    ...
                    <div class="form-desc">Datatables pengajuan legalisir berdasarkan status <code>proses</code></div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($proses as $p) : ?>
                                    <tr>
                                        ...
                                        <td><?= $p['Nama']; ?></td>
                                        <td>
                                            <?php if ($p['upload_ijazah']) : ?>
                                                <?php if ($p['StatusReservasi'] == '1') : ?>
                                                    <a class="mr-2 mb-2 btn btn-secondary" href="<?= base_url() ?>dokumen/ijazah/<?= $p['upload_ijazah']; ?>">Pratinjau</a>
                                        ...
                                        <td>
                                            <?php if ($p['upload_transkip']) : ?>
                                                <?php if ($p['StatusReservasi'] == '1') : ?>
                                                    <a class="mr-2 mb-2 btn btn-secondary" href="<?= base_url() ?>dokumen/ijazah/<?= $p['upload_transkip']; ?>">Pratinjau</a>
                                                <?php elseif ($p['StatusReservasi'] == '2') : ?>
                                                    <?= "Transkip"; ?>
                                                <?php elseif ($p['StatusReservasi'] == '3') : ?>
                                                    <?= "Transkip"; ?>
                                        ...
                                        <td class="row-actions">
                                            <a class="mr-2 mb-2 mt-2 btn btn-primary" href="<?= base_url("legalisir/pengesahanToSelesai/" . $p['ID_Reservasi']); ?>">Berkas Selesai</a>
