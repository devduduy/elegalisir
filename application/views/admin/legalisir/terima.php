        ...
        <div class="content-box">
            <div class="element-wrapper">
                ...
                <div class="element-box">
                    ...
                    <div class="form-desc">Datatables pengajuan legalisir berdasarkan status <code>sudah diambil</code></div>
                                ...
                                <?php foreach ($proses as $p) : ?>
                                    <tr>
                                        ...
                                        <!-- <td class="row-actions">
                                                                                                                                                                <a class="mr-2 mb-2 mt-2 btn btn-primary" href="">Berkas Terima</a>
